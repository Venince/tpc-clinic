...
import {
    ...
    UserGroupIcon, HeartIcon, PrinterIcon, ArrowDownTrayIcon, ChevronDownIcon,
...
export default function StudentShow({ student, appointments, medicineRequests, surveyAnswers, requirements }) {
    ...
    const handleDownloadImage = async () => {
        ...
        try {
            ...
            link.download = `${(u?.name || 'student').replace(/\s+/g, '_')}_profile.png`;
        ...
        <AdminLayout title="Student Profile">
            ...
            <div ref={printRef} className="bg-gray-50 print:bg-white">
                ...
                <div className="print-logo print-header items-center gap-3 mb-4" style={{ display: 'none' }}>
                    ...
                    <div>
                        <p className="font-bold text-gray-900 text-base">TPC e-Clinic — Student Health Profile</p>
                            ...
                            <div className="flex-1 min-w-0 w-full">
                                <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 justify-center sm:justify-start">
                                    ...
                                    <div className="flex items-center justify-center sm:justify-start gap-2">
                                        ...
                                        {student.is_pregnant && <span className="badge badge-red">Pregnant</span>}
                                    </div>
                                </div>
                                <p className="text-sm text-gray-500 mt-1">{student.program?.code} — {student.program?.name}</p>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 print-grid gap-4 mt-5 text-left">
                                    ...
                                    {student.is_pregnant && (
                                        <InfoRow icon={HeartIcon} label="Pregnancy Due Date" value={student.pregnancy_due_date ? new Date(student.pregnancy_due_date).toLocaleDateString() : null} />
                                    )}
                                    {student.medical_notes && (
                                        <div className="sm:col-span-2 lg:col-span-3">
                                            <InfoRow icon={DocumentTextIcon} label="Medical Notes" value={student.medical_notes} />
                                        </div>
                                    )}
                                </div>
                            </div>
