...
import {
    CalendarIcon, BeakerIcon, ClockIcon, MegaphoneIcon,
    ClipboardDocumentCheckIcon,
} from '@heroicons/react/24/outline';

export default function FacultyDashboard({ profile, pendingAppointments, medicineRequests, recentAppointments, announcements, recentWalkins, walkinCount }) {
    const statusBadge = (s) => {
        ...
        <FacultyLayout title="Dashboard">
            ...
            <div className="grid grid-cols-2 gap-3 mb-4">
                <div className="card p-4 text-center">
                    ...
                    <p className="text-xs text-gray-500 leading-tight">Pending Appointments</p>
                ...
                <div className="card p-4 text-center">
                    ...
                    <p className="text-xl sm:text-2xl font-bold">{medicineRequests}</p>
                    <p className="text-xs text-gray-500 leading-tight">Medicine Requests</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                        ...
                        {recentAppointments?.map(a => (
                            <div key={a.id} className="px-4 sm:px-6 py-3 flex items-start justify-between gap-3">
                                <div className="min-w-0">
                                    <p className="text-sm font-medium truncate">{a.purpose}</p>
                ...
                <div className="card lg:col-span-2">
                    <div className="card-header flex items-center justify-between">
                        ...
                        <Link href={route('faculty.walkin.index')} className="text-xs text-clinic-600 hover:underline">View all</Link>
                    </div>
                    <div className="divide-y divide-gray-100">
