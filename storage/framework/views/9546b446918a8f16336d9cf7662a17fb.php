...
th{background:#16a34a;color:#fff;padding:6px 8px;font-size:10px;text-align:left}
...
<table><thead><tr><th>#</th><th>Name</th><th>Program</th><th>Year</th><th>Sex</th><th>Pregnant</th></tr></thead>
<tbody>
...
<tr><td><?php echo e($i+1); ?></td><td><?php echo e($p['user']['name']??'—'); ?></td><td><?php echo e($p['program']['code']??'—'); ?></td><td><?php echo e($p['year_level']??'—'); ?></td><td><?php echo e(ucfirst($p['sex']??'—')); ?></td><td><?php echo e($p['is_pregnant']?'Yes':'No'); ?></td></tr>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><tr><td colspan="6" style="text-align:center">No records.</td></tr><?php endif; ?>
</tbody></table>
</body></html><?php /**PATH C:\Projects\Laravel\tpc-clinic\resources\views/pdf/reports/student_health.blade.php ENDPATH**/ ?>